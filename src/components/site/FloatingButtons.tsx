      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="fixed bottom-24 right-5 z-40 grid h-11 w-11 place-items-center rounded-full bg-paper text-earth shadow-lg ring-1 ring-earth/15 transition hover:-translate-y-0.5 hover:bg-cream"
          >
